...
urlpatterns = [
    ...
    path('customers/<int:pk>/reset-credentials/', views.CustomerAdminResetCredentialsView.as_view(), name='customer_admin_reset_credentials'),
    path('customers/<int:pk>/toggle-portal/', views.CustomerAdminTogglePortalView.as_view(), name='customer_admin_toggle_portal'),
